...
```{r}
df <- rbind(df, data.frame(id = "g", x = 11, y = 42, z = 0, caps = "G"))
```
...
Remember earlier we obtained the gapminder datasetGDP, which contains population and life expentancy for many countries around the world. '[Gapminder](https://youtu.be/BPt8ElTQMIg?t=13)'.
