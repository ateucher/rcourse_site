...
few rows of data, and `tail()` to see the end
...
In RStudio's environment pane, you can also click on the 
...
An index like `[30, 20]` selects a single element of data frame, but we can 
...
and the column name.  Let's look at the petal widths:
