...
This is nice and handy, but you can also chain these things together by using 
the `%>%` operator. This helps make your code very readable, and eliminates the 
need to create intermediate objects.

This is especially true if we want to do several operations that depend on the 
result of a previous operation. Here we want to group by species, use only the 
